...
public class LancamentoResource {
	...
	// lista resumos do retorno
	// filtro em uma API Rest
	// lista paginada com Pegeable(size, page), Page(paginaçao) de uma pesquisa - resumo lançamento
	@GetMapping(params = "resumo")//direfença em relação ao Lançamento
	@PreAuthorize("hasAuthority('ROLE_PESQUISAR_LANCAMENTO') and hasAuthority('SCOPE_read')")
	...
	// tratando a exceção, que será lançada so no lançamento, tratar ela aqui mesmo
